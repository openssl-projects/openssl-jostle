...
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1createTestDrbg  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1createTestDrbg
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1setTestEntropy  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1setTestEntropy
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1randLibctxFipsEnabled  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1randLibctxFipsEnabled
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1ledgerCreated  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1ledgerCreated
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1ledgerDestroyed  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1ledgerDestroyed
#define Java_org_openssl_jostle_util_ops_OperationsTestJNI_op_1ledgerReset  Java_org_openssl_jostle_jcajce_provider_fips_OperationsTestFIPSJNI_op_1ledgerReset
#include "ops.c"

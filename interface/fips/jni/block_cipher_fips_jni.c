...
#define Java_org_openssl_jostle_jcajce_provider_blockcipher_BlockCipherJNI_ni_1cipherFetchable Java_org_openssl_jostle_jcajce_provider_fips_BlockCipherFIPSJNI_ni_1cipherFetchable
/* *INDENT-ON* */

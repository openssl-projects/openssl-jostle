...
#define JO_MAC_MODE_IS_NULL -94

#define JO_RAND_UP_SHORT_RESULT -95
#define JO_RAND_INSUFFICIENT_STRENGTH -96
#define JO_RAND_NO_RAND_UP_CALL -97
#define JO_RAND_ERROR -98
#define JO_RAND_RESEED -99
#define JO_RAND_FAIL_ACCESS_BUFFER -100

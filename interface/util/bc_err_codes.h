...
#define JO_RAND_NO_PRED_RESISTANCE -96
#define JO_RAND_INSUFFICIENT_STRENGTH -97
#define JO_RAND_NO_RAND_METHOD -98
#define JO_RAND_NO_ID_METHOD -99
#define JO_RAND_NO_END_METHOD -100
#define JO_RAND_ERROR -101

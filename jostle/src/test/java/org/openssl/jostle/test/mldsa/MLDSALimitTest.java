...
public class MLDSALimitTest
{
    ...
    public void testMLDSAGenerateKeyPair_keyGenWrongType() throws Exception
    {
        ...
        for (int type : new int[]{-1, 0, 7})
        {
            ...
            try
            {
                mldsaServiceNI.generateKeyPair(type, TestUtil.RNDSrc);
                Assertions.fail();
            }
    ...
    public void MLDSAServiceJNI_getPublicKey_nullKeyRef() throws Exception
    {
        ...
        try
        {
            mldsaServiceNI.getPublicKey(0, new byte[0]);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_getPublicKey_keyRefNullKey() throws Exception
    {
        ...
        try
        {
            mldsaServiceNI.getPublicKey(ref, new byte[0]);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_getPublicKey_outLen() throws Exception
    {
        ...
        try
        {
            mldsaServiceNI.getPublicKey(ref, new byte[10]);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_inputNull() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), null, 0, 0);
            Assertions.fail();
        }
    ...
    public void MLDSAServiceJNI_decode_1publicKey_inputOffsetNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[0], -1, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_inputLenNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[0], 0, -1);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_inputOutOfRange_1() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[10], 1, 10);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_inputOutOfRange_2() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[10], 0, 11);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_keyLength() throws Exception
    {
        ...
        for (int len : new int[]{1311, 1313, 1951, 1953, 2951, 2953})
        {
            ...
            try
            {
                keyRef = TestNISelector.getSpecNI().allocate();
                Assertions.assertTrue(keyRef > 0);
                mldsaServiceNI.decode_publicKey(keyRef, OSSLKeyType.NONE.getKsType(), new byte[len], 0, len);
                Assertions.fail();
            }
            catch (IllegalArgumentException e)
            {
    ...
    public void MLDSAServiceJNI_decode_1publicKey_keyType() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_publicKey(keyRef, 99, new byte[10], 0, 10);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputNull() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), null, 0, 0);
            Assertions.fail();
        }
        catch (NullPointerException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputOffsetNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[0], -1, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputLenNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[0], 0, -1);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputOutOfRange_1() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[10], 1, 10);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputOutOfRange_2() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.ML_DSA_44.getKsType(), new byte[10], 0, 11);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_keyLength() throws Exception
    {
        ...
        for (int len : new int[]{2559, 2561, 4031, 4033, 4895, 4897})
        {
            ...
            try
            {
                keyRef = TestNISelector.getSpecNI().allocate();
                Assertions.assertTrue(keyRef > 0);
                mldsaServiceNI.decode_privateKey(keyRef, OSSLKeyType.NONE.getKsType(), new byte[len], 0, len);
                Assertions.fail();
            }
            catch (IllegalArgumentException e)
            {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_keyType() throws Exception
    {
        ...
        try
        {
            keyRef = TestNISelector.getSpecNI().allocate();
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.decode_privateKey(keyRef, 99, new byte[10], 0, 10);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_decode_1privateKey_inputWrongSize4KeyType() throws Exception
    {
        ...
        for (Object[] tuple : tuples)
        {
            ...
            try
            {
                keyRef = TestNISelector.getSpecNI().allocate();
                Assertions.assertTrue(keyRef > 0);
                mldsaServiceNI.decode_privateKey(keyRef, keyType, key, 0, key.length);
                Assertions.fail();
            }
            catch (IllegalArgumentException e)
            {
    ...
    public void MLDSAServiceJNI_initVerify_ctxLenPastEndOfContext_1() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initVerify(mldsaRef, keyRef, new byte[0], 1, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initVerify_ctxLenPastEndOfContext_2() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initVerify(mldsaRef, keyRef, new byte[1], 2, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initVerify_ctxTooLong() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initVerify(mldsaRef, keyRef, new byte[256], 256, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initVerify_nullKey() throws Exception
    {
        ...
        try
        {
            mldsaRef = TestNISelector.getMLDSANI().allocateSigner();
            Assertions.assertTrue(mldsaRef > 0);
            mldsaServiceNI.initVerify(mldsaRef, keyRef, new byte[1], 1, 0);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initVerify_unknownMuMode() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initVerify(mldsaRef, keyRef, new byte[1], 1, 3);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initSign_ctxLenPastEndOfContext_1() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[0], 1, 0, TestUtil.RNDSrc);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initSign_ctxLenPastEndOfContext_2() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[1], 2, 0, TestUtil.RNDSrc);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initSign_ctxTooLong() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[256], 256, 0, TestUtil.RNDSrc);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initSign_nullKey() throws Exception
    {
        ...
        try
        {
            mldsaRef = TestNISelector.getMLDSANI().allocateSigner();
            Assertions.assertTrue(mldsaRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[1], 1, 0, TestUtil.RNDSrc);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_initSign_unknownMuMode() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[1], 1, 3, TestUtil.RNDSrc);
            Assertions.fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void MLDSAServiceJNI_mldsa_update_notInitialised() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            // (mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[1], 1, 3));

            mldsaServiceNI.update(mldsaRef, new byte[0], 0, 0);
    ...
    public void MLDSAServiceJNI_mldsa_update_nullInput() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.update(mldsaRef, null, 0, 0);
    ...
    public void MLDSAServiceJNI_mldsa_update_inputOffsetNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.update(mldsaRef, new byte[0], -1, 0);
    ...
    public void MLDSAServiceJNI_mldsa_update_inputLenNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.update(mldsaRef, new byte[0], 0, -1);
    ...
    public void MLDSAServiceJNI_mldsa_update_inputOutOfRange_1() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.update(mldsaRef, new byte[10], 0, 11);
    ...
    public void MLDSAServiceJNI_mldsa_update_inputOutOfRange_2() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.update(mldsaRef, new byte[10], 1, 10);
    ...
    public void MLDSAServiceJNI_mldsa_sign_outOffsetNegative() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.sign(mldsaRef, new byte[0], -1, TestUtil.RNDSrc);
    ...
    public void MLDSAServiceJNI_mldsa_sign_notInitialized() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            //(mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[0], 0, 0));

            mldsaServiceNI.sign(mldsaRef, new byte[0], 0, TestUtil.RNDSrc);
    ...
    public void MLDSAServiceJNI_mldsa_sign_nullRand_1() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[0], 0, 0, null);
            Assertions.fail();
    ...
    public void MLDSAServiceJNI_mldsa_sign_nullRand_2() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.sign(mldsaRef, new byte[1024], 0, null);
            Assertions.fail();
    ...
    public void MLDSAServiceJNI_mldsa_sign_outputTooSmall_2() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.sign(mldsaRef, sig, 1, TestUtil.RNDSrc);
    ...
    public void MLDSAServiceJNI_mldsa_sign_outputTooSmall_muOnly_1() throws Exception
    {
        ...
        try
        {
            ...
            Assertions.assertTrue(keyRef > 0);
            mldsaServiceNI.initSign(mldsaRef, keyRef, new byte[0], 0, MLDSASignatureSpi.MuHandling.CALCULATE_MU.ordinal(), TestUtil.RNDSrc);
    ...
    public void MLDSAServiceJNI_mldsa_verify_nullSig() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.verify(mldsaRef, null, 0);
    ...
    public void MLDSAServiceJNI_mldsa_verify_sigLenZero() throws Exception
    {
        ...
        try
        {
            ...
            long code = (mldsaServiceNI.verify(mldsaRef, new byte[1], 0));
    ...
    public void MLDSAServiceJNI_mldsa_verify_sigLenOutOfRange_1() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.verify(mldsaRef, new byte[10], 11);
    ...
    public void MLDSAServiceJNI_mldsa_verify_sigLenOutOfRange_2() throws Exception
    {
        ...
        try
        {
            ...
            mldsaServiceNI.verify(mldsaRef, new byte[0], 1);

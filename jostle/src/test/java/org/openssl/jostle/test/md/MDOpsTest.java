...
public class MDOpsTest
{
    ...
    public void updateByte_openSSLErrorOnUpdateCall() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/nonfips/util/md.c:161
    ...
    public void reset_openSSLErrorOnDigestInit() throws Exception
    {
        ...
        {
            ref = mdNI.allocateDigest("SHA256", 0);
            // Exercises interface/nonfips/util/md.c:204
    ...
    public void digest_final_failed() throws Exception {
        ...
        try {
            // Exercises interface/nonfips/util/md.c:180
    ...
    public void digest_final_failed_xof() throws Exception {
        ...
        try {
            // Exercises interface/nonfips/util/md.c:175
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
            mdNI.digest(ref,new byte[32],0,32);
            Assertions.fail("ops");
        } catch (OpenSSLException e) {
    ...
    public void digest_final_intOverflow() throws Exception {
        ...
        try {
            // Exercises interface/nonfips/util/md.c:185
    ...
    public void copyDigest_failCreate() throws Exception {
        ...
        long ref = mdNI.allocateDigest("SHA256", 0);
        try {
            // Exercises interface/nonfips/util/md.c:102
    ...
    public void copyDigest_copyFailed() throws Exception {
        ...
        long ref = mdNI.allocateDigest("SHA256", 0);
        try {
            // Exercises interface/nonfips/util/md.c:109
    ...
    public void copyDigest_upRefFailed() throws Exception {
        ...
        long ref = mdNI.allocateDigest("SHA256", 0);
        try {
            // Exercises interface/nonfips/util/md.c:117

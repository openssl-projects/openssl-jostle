...
/**
 * FIPS mirror of {@code RSAOpsTest} driving {@link FIPSNISelector#RSAServiceNI}.
 * RSA (2048-bit, F4 public exponent) is FIPS-approved, so this is a straight
 * mirror: the fault sites live in the shared interface/fips/util/rsa.c and the JNI
 * access points in interface/fips/jni/rsa_ni_jni.c, both re-included into the FIPS
 * library, so the {@code // Exercises interface/fips/util/rsa.c:NNN} annotations and
 * the per-site {@code OPS_OFFSET_*}-disambiguated codes are identical to the
 * base. Pinning the exact code / message catches a silent offset renumber.
 *
 * <p>Each test sets exactly one {@code OPS_*} flag in the C-side instrumentation,
 * drives the matching native function, and asserts that the resulting error code
 * or thrown exception matches the expected failure path.
 *
...
public class FIPSRSAOpsTest
{
    ...
    public void RSA_generateKeyPair_failedAccessPubExp() throws Exception
    {
        ...
        try
        {
            // Exercises interface/fips/jni/rsa_ni_jni.c:84
    ...
    public void RSA_decodePublicComponents_failedAccess() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:130
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    public void RSA_getComponent_failedAccessOutput() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:334
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    // These exercise rsa_init_strings_load in interface/fips/jni/rsa_ni_jni.c,
    // shared by both initSign and initVerify. JNI-only.
    // -----------------------------------------------------------------

    /**
     * Target: {@code interface/fips/jni/rsa_ni_jni.c:366} — fault-injects the
    ...
    public void RSA_initSign_accessDigestName_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:371
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    /**
     * Target: {@code interface/fips/jni/rsa_ni_jni.c:372} — fault-injects the
    ...
    public void RSA_initSign_accessMgf1Name_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:377
    ...
    public void RSA_initSign_evpMdCtxNew_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:692
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
    ...
    public void RSA_initSign_digestSignInit_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:697
    ...
    public void RSA_configurePadding_pkcs1_setRsaPadding_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:613
    ...
    public void RSA_configurePadding_pss_setRsaPadding_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:620
    ...
    public void RSA_configurePadding_pss_setMgf1MdName_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:629
    ...
    public void RSA_fromdataConstruct_bldToParam_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:79
    ...
    public void RSA_fromdataConstruct_ctxNewFromName_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:85
    ...
    public void RSA_fromdataConstruct_fromdataInit_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:90
    ...
    public void RSA_fromdataConstruct_fromdata_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:95
    ...
    public void RSA_initVerify_failure_leavesCtxNotInitialized() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:766
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
            int code = rsaServiceNI.ni_initVerify(rsaRef, keyRef, "SHA-256",
                    RSAServiceNI.PADDING_PKCS1, null, 0);
    ...
    public void RSA_initVerify_evpMdCtxNew_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:761
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
            int code = rsaServiceNI.ni_initVerify(rsaRef, keyRef, "SHA-256",
                    RSAServiceNI.PADDING_PKCS1, null, 0);
    ...
    public void RSA_update_failedAccessInput() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:503
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    public void RSA_sign_failedAccessOutput() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:548
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    public void RSA_verify_failedAccessSig() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/jni/rsa_ni_jni.c:593
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    public void RSA_decodePublic_bnBin2bn_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:231
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
            int code = rsaServiceNI.ni_decodePublicComponents(keyRef,
                    new byte[]{0x01}, PUB_EXP_F4);
            // -2 + (-1050) = -1052.
    ...
    public void RSA_decodePublic_paramBldNew_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:236
    ...
    public void RSA_decodePublic_paramBldPushBN_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:241
    ...
    public void RSA_decodePrivate_bnAllocChain_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:283
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);
    ...
    public void RSA_decodePrivate_bnBin2bnD_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:287
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_4);
            int code = rsaServiceNI.ni_decodePrivateComponents(keyRef,
                    new byte[]{0x01}, PUB_EXP_F4, new byte[]{0x01});
            // -2 + (-1061) = -1063.
    ...
    @Test
    public void RSA_decodePrivate_paramBldNew_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        long keyRef = 0;
        try
        {
            keyRef = specNI.allocate();
            Assertions.assertTrue(keyRef > 0);
            // Exercises interface/fips/util/rsa.c:293
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_5);
            int code = rsaServiceNI.ni_decodePrivateComponents(keyRef,
                    new byte[]{0x01}, PUB_EXP_F4, new byte[]{0x01});
            // -2 + (-1062) = -1064.
            Assertions.assertEquals(-1064, code);
        }
        finally
        {
            operationsTestNI.resetFlags();
    ...
    @Test
    public void RSA_decodePrivate_paramBldPush_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        long keyRef = 0;
        try
        {
            keyRef = specNI.allocate();
            Assertions.assertTrue(keyRef > 0);
            // Exercises interface/fips/util/rsa.c:298
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_6);
            int code = rsaServiceNI.ni_decodePrivateComponents(keyRef,
                    new byte[]{0x01}, PUB_EXP_F4, new byte[]{0x01});
            // -2 + (-1063) = -1065.
            Assertions.assertEquals(-1065, code);
        }
        finally
        {
            operationsTestNI.resetFlags();
    ...
    @Test
    public void RSA_decodePrivateCrt_bnAllocChain_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        byte[] one = {0x01};
        long keyRef = 0;
    ...
    @Test
    public void RSA_decodePrivateCrt_bnBin2bn_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        byte[] one = {0x01};
        long keyRef = 0;
        try
        {
            keyRef = specNI.allocate();
            Assertions.assertTrue(keyRef > 0);
            // Exercises interface/fips/util/rsa.c:360
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
            int code = rsaServiceNI.ni_decodePrivateComponentsCrt(keyRef,
                    one, PUB_EXP_F4, one, one, one, one, one, one);
            // -2 + (-1065) = -1067.
            Assertions.assertEquals(-1067, code);
        }
        finally
        {
            operationsTestNI.resetFlags();
    ...
    @Test
    public void RSA_decodePrivateCrt_paramBldNew_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        byte[] one = {0x01};
        long keyRef = 0;
        try
        {
            keyRef = specNI.allocate();
            Assertions.assertTrue(keyRef > 0);
            // Exercises interface/fips/util/rsa.c:371
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);
            int code = rsaServiceNI.ni_decodePrivateComponentsCrt(keyRef,
                    one, PUB_EXP_F4, one, one, one, one, one, one);
            // -2 + (-1066) = -1068.
            Assertions.assertEquals(-1068, code);
        }
        finally
        {
            operationsTestNI.resetFlags();
    ...
    @Test
    public void RSA_decodePrivateCrt_paramBldPush_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        byte[] one = {0x01};
        long keyRef = 0;
        try
        {
            keyRef = specNI.allocate();
            Assertions.assertTrue(keyRef > 0);
            // Exercises interface/fips/util/rsa.c:376
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_4);
            int code = rsaServiceNI.ni_decodePrivateComponentsCrt(keyRef,
                    one, PUB_EXP_F4, one, one, one, one, one, one);
            // -2 + (-1067) = -1069.
            Assertions.assertEquals(-1069, code);
        }
        finally
        {
            operationsTestNI.resetFlags();
    ...
    @Test
    public void RSA_getComponent_bn2bin_failure() throws Exception
    {
        Assumptions.assumeTrue(operationsTestNI.opsTestAvailable());
        long keyRef = 0;
        try
    ...
    public void RSA_getComponent_getBnParam_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:441
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_8);
    ...
    public void RSA_update_sign_digestSignUpdate_failure() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:824
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_9);
    ...
    public void RSA_noneRawInitSign_opensslError() throws Exception
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/rsa.c:545
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_11);
    ...
    public void RSA_noneRawSign_opensslError() throws Exception
    {
        ...
        try
        {
            ...
            OpenSSL.getOpenSSLErrors();
            // Exercises interface/fips/util/rsa.c:863
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_12);
    ...
    public void RSA_noneRawVerify_opensslError() throws Exception
    {
        ...
        try
        {
            ...
            rsaServiceNI.ni_update(rsaRef, new byte[32], 0, 32);
            OpenSSL.getOpenSSLErrors();
            // Exercises interface/fips/util/rsa.c:968
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_11);

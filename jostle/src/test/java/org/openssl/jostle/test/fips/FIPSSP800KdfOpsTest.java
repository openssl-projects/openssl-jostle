...
/**
 * Fault-injection (OPS) tests for the FIPS KBKDF / SSKDF / SSHKDF bridges and
 * util code, mirroring {@code kdf/SP800KdfOpsTest} driving
 * {@link FIPSNISelector#KdfNI}. All three KDFs are FIPS-approved and fetchable
 * on both supported modules, so this is a straight mirror. The FIPS JNI glue is
 * the base {@code kdf_jni.c} re-included under renamed symbols and the
 * util-layer fault sites live in {@code interface/fips/util/kdf.c}, so the
 * {@code // Exercises} annotations point at the same lines and the per-site
 * offsets (KBKDF 4000-block, SSKDF 5000, SSHKDF 6000) are identical. Pinning
 * the exact code catches a silent offset renumber.
 *
 ...
 * {@code opsTestAvailable()}.</p>
 */
public class FIPSSP800KdfOpsTest
{
    ...
    public void kbkdf_access_mode()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:335
    ...
    public void kbkdf_access_mac()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:352
    ...
    public void kbkdf_access_digest()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:363
    ...
    public void kbkdf_access_cipher()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:374
    ...
    public void kbkdf_access_key()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:386
    ...
    public void kbkdf_access_label()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:397
    ...
    public void kbkdf_access_context()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:403
    ...
    public void kbkdf_access_seed()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:409
    ...
    public void kbkdf_access_output()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:414
    ...
    public void sskdf_access_digest()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:494
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
    ...
    public void sskdf_access_secret()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:499
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_2);
            kdfNI.handleErrorCodes(sskdf());
            Assertions.fail();
        }
    ...
    public void sskdf_access_info()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:510
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_3);
            kdfNI.handleErrorCodes(sskdf());
            Assertions.fail();
        }
    ...
    public void sskdf_access_output()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:515
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_4);
            kdfNI.handleErrorCodes(sskdf());
            Assertions.fail();
        }
    ...
    public void sshkdf_access_digest()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:582
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_5);
    ...
    public void sshkdf_access_type()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:599
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_6);
            kdfNI.handleErrorCodes(sshkdf());
            Assertions.fail();
        }
    ...
    public void sshkdf_access_key()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:604
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_1);
            kdfNI.handleErrorCodes(sshkdf());
            Assertions.fail();
        }
    ...
    public void sshkdf_access_xcghash()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:614
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_2);
            kdfNI.handleErrorCodes(sshkdf());
            Assertions.fail();
        }
    ...
    public void sshkdf_access_sessionId()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:624
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_3);
            kdfNI.handleErrorCodes(sshkdf());
            Assertions.fail();
        }
    ...
    public void sshkdf_access_output()
    {
        ...
        try
        {
            // Exercises interface/fips/jni/kdf_jni.c:634
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_FAILED_ACCESS_4);
            kdfNI.handleErrorCodes(sshkdf());
            Assertions.fail();
        }
    ...
    public void kbkdf_fetch_failed()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:198
    ...
    public void kbkdf_create_kdfctx()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:204
    ...
    public void kbkdf_derive()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:240
    ...
    public void sskdf_fetch_failed()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:284
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
            // -2 + (-5002) = -5004.
    ...
    public void sskdf_create_kdfctx()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:290
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
            // -2 + (-5000) = -5002.
    ...
    public void sskdf_derive()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:304
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);
            // -2 + (-5001) = -5003.
    ...
    public void sshkdf_fetch_failed()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:352
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
            // -2 + (-6002) = -6004.
    ...
    public void sshkdf_create_kdfctx()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:358
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
            // -2 + (-6000) = -6002.
    ...
    public void sshkdf_derive()
    {
        ...
        try
        {
            // Exercises interface/fips/util/kdf.c:373
            operationsTestNI.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);
            // -2 + (-6001) = -6003.

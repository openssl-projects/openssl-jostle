...
public class ECDSATest
{
     ...
     * \{INTEGER r, INTEGER s\}}) drives OpenSSL's ECDSA verify to its
     ...
     */
    @Test
    public void testEcdsa_GarbageSignature_raisesSignatureExceptionNotRuntime() throws Exception
    {
        SecureRandom sr = seededRandom("testEcdsa_GarbageSignature_raisesSignatureExceptionNotRuntime");
        KeyPair kp = generateKeyPair("P-256");

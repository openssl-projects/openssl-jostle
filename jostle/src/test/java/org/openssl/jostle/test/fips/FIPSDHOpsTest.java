 ...
 * The FIPS interface library re-includes interface/util/dh.c and the JNI access
 * points in interface/jni/dh_ni_jni.c under renamed symbols, so the per-site

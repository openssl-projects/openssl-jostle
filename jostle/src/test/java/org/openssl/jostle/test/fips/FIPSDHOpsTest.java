...
/**
 * Fault-injection tests for the FIPS DH NI layer. This is a mirror of
 * {@code DHOpsTest} driving {@link FIPSNISelector#DHServiceNI},
 * {@link FIPSNISelector#SpecNI}, and {@link FIPSNISelector#OperationsTestNI}.
 * The FIPS interface library re-includes interface/fips/util/dh.c and the JNI access
 * points in interface/fips/jni/dh_ni_jni.c under renamed symbols, so the per-site
 * {@code OPS_OFFSET_*}-disambiguated codes (DH 5200-block; {@code JO_OPENSSL_ERROR
 * (-2)} minus the offset) are identical by construction. Pinning the exact code
 * catches a silent offset renumber.
 *
 ...
 * <ol>
 *   <li>The {@code dh_generateParameters_*} tests pass a 2048-bit size instead
 *   of the base's 512 (512-bit ad-hoc DH paramgen is not FIPS-approved). The
 *   injected fault short-circuits before the real prime search, so 2048 stays
 *   fast and the real {@code set_params(2048)} is accepted.</li>
 *   <li>FIPS: omitted {@code dh_generateParameters_specKeyNull_failure}
 *   (offset 5214, dh.c:220). That site requires a REAL {@code EVP_PKEY_paramgen}
 *   to succeed before the injected {@code spec->key == NULL} check fires; at a
 *   FIPS-approved size the ad-hoc DH safe-prime search is prohibitively slow,
 *   and the base's 512-bit size is not FIPS-approved. Every other
 *   {@code dh_generateParameters} test short-circuits before the real paramgen,
 *   so those are kept (bumped to 2048).</li>
 * </ol>
 *
 * <h2>Target map: offset → {@code interface/fips/util/dh.c} fault-injection line</h2>
 *
 * <pre>
...
public class FIPSDHOpsTest
{
    ...
    public void dh_generateKeyPairByGroup_ctxNewFromName_failure()
    {
        ...
        // Exercises interface/fips/util/dh.c:128
    ...
    public void dh_generateKeyPairByGroup_keygenInit_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:133
    ...
    public void dh_generateKeyPairByGroup_setParams_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:143
    ...
    public void dh_generateParameters_ctxNewFromName_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:194
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_6);

        int[] err = new int[1];
        long ref = dh.ni_generateParameters(2048, err, TestUtil.RNDSrc);
        Assertions.assertEquals(0L, ref);
    ...
    public void dh_generateParameters_setParams_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:216
    ...
    public void dh_generateParameters_paramgen_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:221
    ...
    public void dh_makeParams_bnBin2bn_failure()
    {
        ...
        // Exercises interface/fips/util/dh.c:303
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_6);
    ...
    public void dh_makeParams_pushPG_failure()
    {
        ...
        byte[] p = component(DHServiceNI.COMP_P);
        byte[] g = component(DHServiceNI.COMP_G);
        // Exercises interface/fips/util/dh.c:363
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_9);
    ...
    public void dh_makeParams_toParam_failure()
    {
        ...
        byte[] p = component(DHServiceNI.COMP_P);
        byte[] g = component(DHServiceNI.COMP_G);
        // Exercises interface/fips/util/dh.c:385
    ...
    public void dh_makePrivate_bnBin2bnX_failure()
    {
        ...
        // Exercises interface/fips/util/dh.c:324
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_4);
    ...
    public void dh_makePrivate_bnModExp_failure()
    {
        ...
        byte[] g = component(DHServiceNI.COMP_G);
        byte[] x = component(DHServiceNI.COMP_PRIVATE_VALUE);
        // Exercises interface/fips/util/dh.c:349
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_7);
    ...
    public void dh_makePrivate_pushPub_failure()
    {
        ...
        byte[] g = component(DHServiceNI.COMP_G);
        byte[] x = component(DHServiceNI.COMP_PRIVATE_VALUE);
        // Exercises interface/fips/util/dh.c:370
    ...
    public void dh_makePrivate_pushPriv_failure()
    {
        ...
        byte[] g = component(DHServiceNI.COMP_G);
        byte[] x = component(DHServiceNI.COMP_PRIVATE_VALUE);
        // Exercises interface/fips/util/dh.c:377
    ...
    public void dh_makePublic_bnBin2bnY_failure()
    {
        ...
        // Exercises interface/fips/util/dh.c:310
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);
    ...
    public void dh_generateKeyPair_keygenInit_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:524
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_4);
    ...
    public void dh_generateKeyPair_keygen_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:529
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_5);
    ...
    public void dh_generateKeyPair_specKeyNull_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:534
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_6);
    ...
    public void dh_getComponent_getBnParam_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:562
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_7);
    ...
    public void dh_getComponent_bnNumBytes_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:568
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_8);
    ...
    public void dh_getComponent_bn2bin_failure()
    {
        Assumptions.assumeTrue(ops.opsTestAvailable());
        OpenSSL.getOpenSSLErrors();
        // Exercises interface/fips/util/dh.c:584
        ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_9);
    ...
    public void dh_kexInit_ctxNewFromPkey_failure()
    {
        ...
        try
        {
            // Exercises interface/fips/util/dh.c:688
            ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_11);
    ...
    public void dh_kexInit_deriveInit_failure()
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/dh.c:693
            ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_12);
            int code = dh.ni_kexInit(ref, keyRef, TestUtil.RNDSrc);
    ...
    public void dh_kexSetPeer_failure()
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/dh.c:775
            ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_1);
    ...
    public void dh_kexDerive_probe_failure()
    {
        ...
        try
        {
            ...
            // Exercises interface/fips/util/dh.c:808
            ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_2);
    ...
    public void dh_kexDerive_fetch_failure()
    {
        ...
        try
        {
            dh.kexInit(ref, keyRef, TestUtil.RNDSrc);
            dh.kexSetPeer(ref, peerRef, TestUtil.RNDSrc);
            // Exercises interface/fips/util/dh.c:829
            ops.setFlag(OperationsTestNI.OpsTestFlag.OPS_OPENSSL_ERROR_3);

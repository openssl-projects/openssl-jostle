...
/**
 * Canary for {@code src/test/java25} on the integration leg.
 *
 * <p>That leg filters to {@code *LimitTest*}, {@code *IntegrationTest*} and
 * {@code *OpsTest*}, so {@link SourceSet25CanaryTest} cannot reach it. Keep
 * this trivial and dependency-free; see the canary section of
 * {@code .claude/guides/testing.md}.
 */
public class SourceSet25CanaryIntegrationTest
{
    @Test
    public void thisSourceSetRanOnAJdkOfAtLeastItsOwnLevel()
    {
        ...
        Assertions.assertTrue(running >= 25,
                "src/test/java25 ran on JDK " + running

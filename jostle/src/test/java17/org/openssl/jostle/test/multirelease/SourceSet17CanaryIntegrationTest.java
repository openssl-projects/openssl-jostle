...
/**
 * Canary for {@code src/test/java17} on the integration leg.
 *
 * <p>That leg filters to {@code *LimitTest*}, {@code *IntegrationTest*} and
 * {@code *OpsTest*}, so {@link SourceSet17CanaryTest} cannot reach it. Keep
 * this trivial and dependency-free; see the canary section of
 * {@code .claude/guides/testing.md}.
 */
public class SourceSet17CanaryIntegrationTest
{
    @Test

...
/**
 * FFM binding for the {@code JoDSA_*} symbols exported by
 * {@code interface/nonfips/ffm/dsa_ni_ffm.c}.
 */
...
public class DSAServiceFFM implements DSAServiceNI
{
    private static final Logger L = Logger.getLogger("DSA_NI_FFM");
    ...
    public DSAServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public DSAServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public DSAServiceFFM(SymbolLookup lookup, String symPrefix)
    {
    ...
    public long ni_generateParameters(int pBits, int qBits, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_generateParameters", t);
    ...
    public long ni_makeParamsFromComponents(byte[] p, byte[] q, byte[] g, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_makeParamsFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_generateKeyPair(long paramsRef, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_generateKeyPair", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                                             ...
                                             int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_makePrivateFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                                            ...
                                            int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_makePublicFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_getComponent(long specRef, int component, byte[] out)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_getComponent", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_allocateSigner(int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_allocateSigner", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public void ni_disposeSigner(long reference)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_disposeSigner", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_initSign(long ref, long keyRef, String digestName, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_initSign", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_initVerify(long ref, long keyRef, String digestName)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_initVerify", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_update(long ref, byte[] input, int inOff, int inLen)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_update", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_sign(long ref, byte[] sig, int outOff, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_sign", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_verify(long ref, byte[] sig, int sigLen, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DSA_verify", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
}

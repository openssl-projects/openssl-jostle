...
// silently drive the BASE library (see MDServiceFFM, FIPSLibraryLookup).
public class EdDSAServiceFFM implements EDServiceNI
{
    ...
    private static final Logger L = Logger.getLogger("EdDSA_NI_FFM");
    ...
    public EdDSAServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public EdDSAServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public EdDSAServiceFFM(SymbolLookup lookup, String symPrefix)
    {
    ...
    public int ni_decode_privateKey(long spec_ref, int keyType, byte[] input, int inputOffset, int inputLen)
    {
        ...
        {
            L.log(Level.WARNING,
                    "FFM JoEDDSA_decodePrivateKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }

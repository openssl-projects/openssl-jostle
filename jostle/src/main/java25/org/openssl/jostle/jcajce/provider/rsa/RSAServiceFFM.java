...
/**
 * FFM binding for the {@code RSA_*} symbols exported by
 * {@code interface/nonfips/ffm/rsa_ni_ffm.c}. Mirrors the structure of
 * {@link org.openssl.jostle.jcajce.provider.ed.EdDSAServiceFFM};
...
public class RSAServiceFFM implements RSAServiceNI
{
    private static final Logger L = Logger.getLogger("RSA_NI_FFM");
    ...
    public RSAServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public RSAServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public RSAServiceFFM(SymbolLookup lookup, String symPrefix)
    {
    ...
    public long ni_allocateSigner(int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_allocateSigner", t);
    ...
    public void ni_disposeSigner(long reference)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_disposeSigner", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_generateKeyPair(int bits, byte[] pubExp, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_generateKeyPair", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_decodePublicComponents(long specRef, byte[] n, byte[] e)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_decodePublicComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_decodePrivateComponents(long specRef, byte[] n, byte[] e, byte[] d)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_decodePrivateComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                                             ...
                                             byte[] dp, byte[] dq, byte[] qinv)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_decodePrivateComponentsCrt", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_getComponent(long specRef, int component, byte[] out)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_getComponent", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                           ...
                           RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_initSign", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                             ...
                             int paddingMode, String mgf1MdName, int saltLen)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_initVerify", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_update(long ref, byte[] input, int inOff, int inLen)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_update", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_sign(long ref, byte[] sig, int outOff, RandSource rndSource)
    {
        ...
        // when sig is non-null to keep the FFM side from needing to know
        ...
        {
            L.log(Level.WARNING, "FFM RSA_sign", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_verify(long ref, byte[] sig, int sigLen)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSA_verify", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }

...
public class KdfNIFFM implements KdfNI
{
    //KDF_PBKDF2

    private static final Logger L = Logger.getLogger("KDF_NI_FFM");
    ...
    public KdfNIFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public KdfNIFFM(SymbolLookup lookup, String symPrefix)
    {

...
import org.openssl.jostle.jcajce.provider.blockcipher.CCMCipherFFM;

/**
 * FFM implementation of CCMCipherNI backed by the FIPS interface library:
 * the base marshalling with a library-scoped lookup pinned to the extracted
 * FIPS library (see {@link FIPSLibraryLookup}).
 */
class CCMCipherFIPSFFM extends CCMCipherFFM
{
    CCMCipherFIPSFFM()
    {

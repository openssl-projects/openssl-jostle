...
import org.openssl.jostle.jcajce.provider.blockcipher.BlockCipherFFM;

/**
 * FFM implementation of BlockCipherNI backed by the FIPS interface library:
 * the base marshalling with a library-scoped lookup pinned to the extracted
 * FIPS library (see {@link FIPSLibraryLookup}).
 */
class BlockCipherFIPSFFM extends BlockCipherFFM
{
    BlockCipherFIPSFFM()
    {

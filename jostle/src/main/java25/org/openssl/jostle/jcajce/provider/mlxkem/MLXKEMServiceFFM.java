...
public class MLXKEMServiceFFM implements MLXKEMServiceNI
{
    private static final Logger L = Logger.getLogger("MLXKEM_NI_FFM");
    ...
    public MLXKEMServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public MLXKEMServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public MLXKEMServiceFFM(SymbolLookup lookup, String symPrefix)
    {
        this.lookup = lookup;
    ...
    public long ni_generateKeyPair(int type, int[] err, RandSource randSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoMLXKEM_generateKeyPair", t);
    ...
    public int ni_getPublicKey(long ref, byte[] output)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoMLXKEM_getPublicKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_getPrivateKey(long ref, byte[] output)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoMLXKEM_getPrivateKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                       ...
                       byte[] input, int inputOffset, int inputLen)
    {
        ...
        {
            L.log(Level.WARNING, "FFM " + name, t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
}

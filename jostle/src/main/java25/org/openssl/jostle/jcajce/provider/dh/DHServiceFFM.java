...
/**
 * FFM binding for the {@code JoDH_*} symbols exported by
 * {@code interface/nonfips/ffm/dh_ni_ffm.c}.
 */
...
public class DHServiceFFM implements DHServiceNI
{
    private static final Logger L = Logger.getLogger("DH_NI_FFM");
    ...
    public DHServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public DHServiceFFM(SymbolLookup lookup, String symPrefix)
    {
        groupSupportedH = bind(lookup, symPrefix + "JoDH_groupSupported",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));

        // JoDH_generateKeyPairByGroup(const char* group_name, int32_t* err,
        //                             void* rnd_src) -> key_spec*
        generateKeyPairByGroupH = bind(lookup, symPrefix + "JoDH_generateKeyPairByGroup",
        ...
        // upcall.
        generateParametersH = bind(lookup, symPrefix + "JoDH_generateParameters",
                FunctionDescriptor.of(
                        ValueLayout.ADDRESS,
        ...
        //                      void* rnd_src) -> key_spec*
        generateKeyPairH = bind(lookup, symPrefix + "JoDH_generateKeyPair",
                FunctionDescriptor.of(
                        ValueLayout.ADDRESS,
        ...
        getComponentH = bind(lookup, symPrefix + "JoDH_getComponent",
                FunctionDescriptor.of(
        ...
        allocKexH = bind(lookup, symPrefix + "JoDH_allocateKex",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

        disposeKexH = linker.downcallHandle(
                lookup.find(symPrefix + "JoDH_disposeKex").orElseThrow(),
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

        // JoDH_kexInit(dh_kex_ctx*, key_spec*, void* rnd_src) -> int
        kexInitH = bind(lookup, symPrefix + "JoDH_kexInit",
                FunctionDescriptor.of(
                        ValueLayout.JAVA_INT,
                        ValueLayout.ADDRESS,
                        ValueLayout.ADDRESS,
        ...
        kexSetPeerH = bind(lookup, symPrefix + "JoDH_kexSetPeer",
                FunctionDescriptor.of(
                        ValueLayout.JAVA_INT,
                        ValueLayout.ADDRESS,
                        ValueLayout.ADDRESS,
        ...
        kexDeriveH = bind(lookup, symPrefix + "JoDH_kexDerive",
                FunctionDescriptor.of(
                        ValueLayout.JAVA_INT,
                        ValueLayout.ADDRESS,
                        ValueLayout.ADDRESS,
    ...
    public int ni_groupSupported(String groupName)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_groupSupported", t);
    ...
    public long ni_generateKeyPairByGroup(String groupName, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_generateKeyPairByGroup", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_generateParameters(int pBits, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_generateParameters", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_makeParamsFromComponents(byte[] p, byte[] q, byte[] g, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_makeParamsFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_generateKeyPair(long paramsRef, int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_generateKeyPair", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                                             ...
                                             int[] err, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_makePrivateFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                                            ...
                                            int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_makePublicFromComponents", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_getComponent(long specRef, int component, byte[] out)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_getComponent", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_allocateKex(int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_allocateKex", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public void ni_disposeKex(long reference)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_disposeKex", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_kexInit(long ref, long keyRef, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_kexInit", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_kexSetPeer(long ref, long peerRef, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_kexSetPeer", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_kexDerive(long ref, byte[] out, int outOff, RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM DH_kexDerive", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
}

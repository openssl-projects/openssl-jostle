...
public class NativeServiceFFM implements NativeServiceNI
{
    ...
    public boolean isNativeAvailable()
    {
        try
        {
            ...
            return FFM.ffm_bool((byte) dch.invokeExact());
        }
        catch (Throwable e)
        {
            L.warning("ffm access to isNativeAvailable: " + e.getMessage());
        }
        return false;
    }

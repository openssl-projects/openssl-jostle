...
public class MLKEMServiceFFM implements MLKEMServiceNI
{


    private static final Logger L = Logger.getLogger("MLKEM_NI_FFM");
    ...
    public MLKEMServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public MLKEMServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public MLKEMServiceFFM(SymbolLookup lookup, String symPrefix)
    {
        this.lookup = lookup;
    ...
    public long ni_generateKeyPair(int type, int[] err, byte[] seed, int seedLen, RandSource randSource)
    {
        ...
        {
            L.log(Level.WARNING,
                    "FFM JoMLKEM_generateKeyPair (seed)", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_decode_privateKey(long spec_ref, int keyType, byte[] input, int inputOffset, int inputLen, RandSource randSource)
    {
        ...
        {
            L.log(Level.WARNING,
                    "FFM JoMLKEM_decodePrivateKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
}

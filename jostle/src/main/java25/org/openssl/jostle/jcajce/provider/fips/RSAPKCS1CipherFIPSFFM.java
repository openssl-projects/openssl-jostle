...
import org.openssl.jostle.jcajce.provider.rsa.RSAPKCS1CipherFFM;

/**
 * FFM implementation backed by the FIPS interface library: the base
 * marshalling with a library-scoped lookup pinned to the extracted FIPS
 * library (see {@link FIPSLibraryLookup}).
 */
class RSAPKCS1CipherFIPSFFM extends RSAPKCS1CipherFFM
{
    RSAPKCS1CipherFIPSFFM()
    {

...
public class SLHDSAServiceFFM implements SLHDSAServiceNI
{
    ...
    private static final Logger L = Logger.getLogger("SLH_DSA_NI_FFM");
    ...
    public SLHDSAServiceFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public SLHDSAServiceFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public SLHDSAServiceFFM(SymbolLookup lookup, String symPrefix)
    {
        this.lookup = lookup;
    ...
    public long ni_generateKeyPair(int type, int[] err, byte[] seed, int seedLen, RandSource randSource)
    {
        ...
        {
            L.log(Level.WARNING,
                    "FFM SLH_DSA_generateKeyPair (seed)", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_decode_privateKey(long specRef, int keyType, byte[] input, int inputOffset, int inputLen)
    {
        ...
        {
            L.log(Level.WARNING,
                    "FFM SLH_DSA_decodePrivateKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }

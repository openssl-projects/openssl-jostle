...
public class KSServiceFFM
    implements KSServiceNI
{
    private static final Logger L = Logger.getLogger("KS_NI_FFM");
     ...
     * KSServiceFIPSFFM). The handles are therefore INSTANCE fields — a static
     * handle would bind whichever library initialised the class first.
     */
    public KSServiceFFM(SymbolLookup lookup)
    {
    ...
    public long ni_allocateKeyStore(String type, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_Allocate", t);
    ...
    public void ni_dispose(long ref)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_Dispose", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_load(long ref, byte[] input, byte[] password)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_Load", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                           ...
                           int macDigest, int pbeIter, int macIter, int[] err, RandSource randSource)
    {
        ...
        try (Arena a = Arena.ofConfined())
        {
            ...
            finally
            {
                ...
                // FFM downcall that copies secret material into an Arena must do
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_Store", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public byte[] ni_getKey(long ref, String alias, byte[] password, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_GetKey", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public byte[] ni_getCertificateChain(long ref, String alias, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_GetCertificateChain", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_setCertificateChain(long ref, String alias, byte[] chain)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_SetCertificateChain", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_setCertificateEntry(long ref, String alias, byte[] certificate)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_SetCertificateEntry", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_deleteEntry(long ref, String alias)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_DeleteEntry", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public byte[] ni_getAliases(long ref, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_GetAliases", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_containsAlias(long ref, String alias)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_ContainsAlias", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_size(long ref)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_Size", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_isKeyEntry(long ref, String alias)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_IsKeyEntry", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public int ni_isCertificateEntry(long ref, String alias)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_IsCertificateEntry", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
    ...
    public long ni_getCreationDate(long ref, String alias, int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM JoKS_GetCreationDate", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }

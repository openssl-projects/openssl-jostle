...
/**
 * FFM binding for the {@code JoRSAOAEP_*} symbols exported by
 * {@code interface/nonfips/ffm/rsa_oaep_ni_ffm.c}. Mirrors {@link RSAServiceFFM};
...
public class RSAOAEPCipherFFM implements RSAOAEPCipherNI
{
    private static final Logger L = Logger.getLogger("RSA_OAEP_NI_FFM");
    ...
    public RSAOAEPCipherFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public RSAOAEPCipherFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public RSAOAEPCipherFFM(SymbolLookup lookup, String symPrefix)
    {
    ...
    public long ni_allocateCipher(int[] err)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSAOAEP_allocateCipher", t);
    ...
    public void ni_disposeCipher(long reference)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSAOAEP_disposeCipher", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                       ...
                       RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSAOAEP_init", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
                          ...
                          RandSource rndSource)
    {
        ...
        {
            L.log(Level.WARNING, "FFM RSAOAEP_doFinal", t);
            throw new RuntimeException(t.getMessage(), t);
        }
    }
}

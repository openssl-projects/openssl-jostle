...
/**
 * FFM implementation of {@link OpenSSLFIPSNI}, backed by the FIPS interface
 * library (libinterface_fips_ffm).
 *
 * <p>Unlike the base FFM implementations, symbols are resolved through the
 ...
 * rationale.
 */
class OpenSSLFIPSFFM implements OpenSSLFIPSNI
{
    ...
    public int setOSSLFIPSModule(String moduleDir, String providerName, String configPath)
    {
        ...
        {
            L.log(Level.WARNING, "ffm JoFIPS_set_openssl_module", t);
    ...
    public int canFetch(int opType, String name)
    {
        ...
        {
            L.log(Level.WARNING, "ffm JoFIPS_can_fetch", t);
            throw new ProviderException(t.getMessage(), t);
        }
    }
    ...
    public String moduleVersion()
    {
        ...
        {
            L.log(Level.WARNING, "ffm JoFIPS_module_version", t);
            throw new ProviderException(t.getMessage(), t);
        }
    }
    ...
    public String implementingProvider(int opType, String name)
    {
        ...
        {
            L.log(Level.WARNING, "ffm JoFIPS_implementing_provider", t);
            throw new ProviderException(t.getMessage(), t);
        }
    }
    ...
    public String getOSSLErrors()
    {
        ...
        try (Arena arena = Arena.ofConfined())
        {
            ...
            finally
            {
                if (content != null)
                {
                    FFM.insecureUnsafeFree(content);
                }
            }
        }
        return result;

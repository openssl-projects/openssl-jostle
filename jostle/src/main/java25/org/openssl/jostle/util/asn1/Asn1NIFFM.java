...
public class Asn1NIFFM implements Asn1Ni
{

    private static final Logger L = Logger.getLogger("ASN1_NI_FFM");
    ...
    public Asn1NIFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public Asn1NIFFM(SymbolLookup lookup, String symPrefix)
    {

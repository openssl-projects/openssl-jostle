...
/**
 * FFM implementation of {@link OperationsTestNI}. Marshalling is parameterised
 ...
 * base library); {@code OperationsTestFIPSFFM} passes a library-scoped lookup
 ...
 */
public class OperationsTestFFM implements OperationsTestNI
{
    ...
    // static block (the SpecFFM lesson): they carry no native handle.
    ...
    public OperationsTestFFM()
    {
        this(SymbolLookup.loaderLookup());
    }

    public OperationsTestFFM(SymbolLookup lookup)
    {
        this(lookup, "");
    }
     ...
     */
    public OperationsTestFFM(SymbolLookup lookup, String symPrefix)
    {

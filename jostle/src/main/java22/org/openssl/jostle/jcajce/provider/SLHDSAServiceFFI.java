...
//    }
    ...
    @Override
    public long sign(long ref, byte[] output, int offset)
    {
        try
        {
            MemorySegment ctx = MemorySegment.ofAddress(ref);
    ...
    @Override
    public long initSign(long reference, long keyReference, byte[] context, int contextLen, int messageEncoding, int deterministic)
    {
        try
        {

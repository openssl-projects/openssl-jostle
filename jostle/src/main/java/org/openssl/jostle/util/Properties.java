...
public class Properties
{
     ...
     * @return true if the property is set to "true", false otherwise.
     */
    public static boolean isOverrideSet(String propertyName, boolean defaultValue)
    {
        try
        {
    ...
    public static String getPropertyValue(final String propertyName)
    {
        ...
        String val = AccessWrapper.doAction(() -> Security.getProperty(propertyName));
        ...
        return AccessWrapper.doAction(() -> System.getProperty(propertyName));

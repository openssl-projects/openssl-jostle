...
class ProvFIPSSLHDSA
{
    ...
    private void configureSLHDSA(final JostleFIPSProvider provider)
    {
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "SLHDSA", PREFIX + "SLHDSAKeyPairGenerator", slhdsaKeyGenAttr, (arg) -> new SLHDSAKeyPairGenerator(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, "SLH-DSA"));
        provider.addAlias("KeyPairGenerator", "SLHDSA", "SLH-DSA");

        provider.addAlgorithmImplementation("KeyFactory", "SLHDSA", PREFIX + "SLHDSAKeyFactory", slhdsaKeyGenAttr, (arg) -> new SLHDSAKeyFactorySpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, FIPSNISelector.Asn1NI, OSSLKeyType.NONE));
        provider.addAlias("KeyFactory", "SLHDSA", "SLH-DSA");


        SLHDSAParameterSpec.getParameterNames().forEach(name ->
        {
            provider.addAlgorithmImplementation("KeyPairGenerator", name, PREFIX + "SLHDSAKeyPairGeneratorSpi$" + name.replace("-", "_"), slhdsaKeyGenAttr, (arg) -> new SLHDSAKeyPairGenerator(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, name));
            provider.addAlgorithmImplementation("KeyFactory", name, PREFIX + "SLHDSAKeyFactorySpi$" + name.replace("-", "_"), slhdsaKeyGenAttr, (arg) -> new SLHDSAKeyFactorySpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, FIPSNISelector.Asn1NI, SLHDSAParameterSpec.fromName(name).getKeyType()));
        });

        final Map<String, String> slhdsaSigAttr = new HashMap<String, String>();

        provider.addAlgorithmImplementation("Signature", "SLHDSA", PREFIX + "SLHDSASignatureSpi$SLHDSA", slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, OSSLKeyType.NONE, SLHDSASignatureSpi.MessageEncoding.PURE, SLHDSASignatureSpi.Deterministic.NON_DETERMINISTIC));
        provider.addAlias("Signature", "SLHDSA", "SLH-DSA");

        provider.addAlgorithmImplementation("Signature", "SLH-DSA-PURE", PREFIX + "SLHDSASignatureSpi$SLHDSA_Pure", slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, OSSLKeyType.NONE, SLHDSASignatureSpi.MessageEncoding.PURE, SLHDSASignatureSpi.Deterministic.NON_DETERMINISTIC));
        provider.addAlgorithmImplementation("Signature", "SLH-DSA-NONE", PREFIX + "SLHDSASignatureSpi$SLHDSA_None", slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, OSSLKeyType.NONE, SLHDSASignatureSpi.MessageEncoding.NONE, SLHDSASignatureSpi.Deterministic.NON_DETERMINISTIC));

        provider.addAlgorithmImplementation("Signature", "DET-SLH-DSA-PURE", PREFIX + "SLHDSASignatureSpi$SLHDSADetPure", slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, OSSLKeyType.NONE, SLHDSASignatureSpi.MessageEncoding.PURE, SLHDSASignatureSpi.Deterministic.DETERMINISTIC));
        provider.addAlgorithmImplementation("Signature", "DET-SLH-DSA-NONE", PREFIX + "SLHDSASignatureSpi$SLHDSADetNone", slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, OSSLKeyType.NONE, SLHDSASignatureSpi.MessageEncoding.NONE, SLHDSASignatureSpi.Deterministic.DETERMINISTIC));


        for (String algName : algNames)
        {
            provider.addAlgorithmImplementation("Signature", algName, PREFIX + "SLHDSASignatureSpi$" + algName.replace("-", "_"), slhdsaSigAttr, (arg) -> new SLHDSASignatureSpi(FIPSNISelector.SLHDSAServiceNI, FIPSNISelector.SpecNI, SLHDSAParameterSpec.fromName(algName).getKeyType(), SLHDSASignatureSpi.MessageEncoding.PURE, SLHDSASignatureSpi.Deterministic.NON_DETERMINISTIC));
        }

...
/**
 * JNI implementation of {@link MLDSAServiceNI} backed by the FIPS interface library;
 * the glue is the base bridge re-included under renamed exports
 * ({@code interface/fips/jni/mldsa_fips_jni.c}).
 *
 ...
 */
class MLDSAServiceFIPSJNI implements MLDSAServiceNI
{
    @Override

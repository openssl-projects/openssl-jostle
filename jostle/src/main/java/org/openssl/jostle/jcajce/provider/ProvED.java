...
class ProvED
{
    ...
    private void configureEDDSA(final JostleProvider provider)
    {
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED", EdDSAKeyPairGenerator.class.getName(), attr, (arg) -> keyPairGenerator(provider, "EDDSA"));
        provider.addAlias("KeyPairGenerator", "ED", "EDDSA", "EdDSA");
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED25519", EdDSAKeyPairGenerator.class.getName(), attr, (arg) -> keyPairGenerator(provider, EdDSAParameterSpec.ED25519));
        provider.addAlias("KeyPairGenerator", "ED25519", "Ed25519");
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED448", EdDSAKeyPairGenerator.class.getName(), attr, (arg) -> keyPairGenerator(provider, EdDSAParameterSpec.ED448));
        provider.addAlias("KeyPairGenerator", "ED448", "Ed448");

        final Map<String, String> sigAttr = new HashMap<>();

        provider.addAlgorithmImplementation("Signature", "EDDSA", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.NONE));
        provider.addAlias("Signature", "EDDSA", "EdDSA");

        provider.addAlgorithmImplementation("Signature", "ED25519", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED25519));
        ...
        provider.addAlgorithmImplementation("Signature", "ED25519PH", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.Ed25519ph));
        provider.addAlias("Signature", "ED25519PH", "Ed25519ph");
        provider.addAlgorithmImplementation("Signature", "ED25519CTX", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.Ed25519ctx));
        provider.addAlias("Signature", "ED25519CTX", "Ed25519ctx");

        provider.addAlgorithmImplementation("Signature", "ED448", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED448));
        provider.addAlias("Signature", "ED448", "Ed448");
        provider.addAlias("Signature", "ED448", EdECObjectIdentifiers.id_Ed448);
        provider.addAlgorithmImplementation("Signature", "ED448PH", EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED448ph));
        provider.addAlias("Signature", "ED448PH", "Ed448ph");


        final Map<String, String> kfAttr = new HashMap<>();
        provider.addAlgorithmImplementation("KeyFactory", "ED", EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.NONE));
        provider.addAlias("KeyFactory", "ED", "EDDSA", "EdDSA");
        provider.addAlgorithmImplementation("KeyFactory", "ED25519", EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.ED25519));
        ...
        provider.addAlgorithmImplementation("KeyFactory", "ED448", EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.ED448));

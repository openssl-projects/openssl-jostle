...
/**
 * JNI implementation of RSAOAEPCipherNI backed by the FIPS interface library
 * (libinterface_fips_jni); the glue is the base bridge re-included under
 * renamed Java_*_fips_RSAOAEPCipherFIPSJNI_* exports.
 */
class RSAOAEPCipherFIPSJNI implements RSAOAEPCipherNI
{
    @Override

...
/**
 * JNI implementation of RSAServiceNI backed by the FIPS interface library
 * (libinterface_fips_jni); the glue is the base bridge re-included under
 * renamed Java_*_fips_RSAServiceFIPSJNI_* exports.
 */
class RSAServiceFIPSJNI implements RSAServiceNI
{
    @Override

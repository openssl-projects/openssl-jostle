...
public enum ErrorCode
{
    ...
    JO_KDF_SCRYPT_N_NEGATIVE(-79),
    JO_KDF_SCRYPT_R_NEGATIVE(-80),
    JO_KDF_SCRYPT_P_NEGATIVE(-81),

    JO_KDF_PBE_ITER_NEGATIVE(-82),
    JO_KDF_PBE_UNKNOWN_DIGEST(-83),
    JO_KDF_OUTPUT_NULL(-84),
    JO_KDF_OUTPUT_FAILED_ACCESS(-85),
    JO_KDF_OUTPUT_OFFSET_NEGATIVE(-86),
    JO_KDF_OUTPUT_LEN_NEGATIVE(-87),

...
/**
 * Finite-field Diffie-Hellman key-agreement SPI. Wraps OpenSSL's
 * {@code EVP_PKEY_derive} flow: {@code init(privKey)} binds the local
 * private key, {@code doPhase(pubKey, true)} sets the peer, and
 * {@code generateSecret} returns the shared secret.
 *

...
class ProvFIPSED
{
    ...
    public void configure(final JostleFIPSProvider provider)
    {
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED",
                EdDSAKeyPairGenerator.class.getName(), attr, (arg) -> keyPairGenerator(provider, "EDDSA"));
        provider.addAlias("KeyPairGenerator", "ED", "EDDSA", "EdDSA");
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED25519",
                EdDSAKeyPairGenerator.class.getName(), attr,
        ...
        if (ed25519 || ed448)
        {
            provider.addAlgorithmImplementation("Signature", "EDDSA",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.NONE));
        ...
        if (ed25519)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED25519));
        ...
        if (ed25519ph)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519PH",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.Ed25519ph));
            provider.addAlias("Signature", "ED25519PH", "Ed25519ph");
        }
        if (ed25519ctx)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519CTX",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.Ed25519ctx));
            provider.addAlias("Signature", "ED25519CTX", "Ed25519ctx");
        }
        if (ed448)
        {
            provider.addAlgorithmImplementation("Signature", "ED448",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED448));
        ...
        if (ed448ph)
        {
            provider.addAlgorithmImplementation("Signature", "ED448PH",
                    EdSignatureSpi.class.getName(), sigAttr, (arg) -> signature(provider, OSSLKeyType.ED448ph));
        ...
        provider.addAlgorithmImplementation("KeyFactory", "ED",
                EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.NONE));
        provider.addAlias("KeyFactory", "ED", "EDDSA", "EdDSA");
        provider.addAlgorithmImplementation("KeyFactory", "ED25519",
                EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.ED25519));
        ...
        provider.addAlgorithmImplementation("KeyFactory", "ED448",
                EdKeyFactorySpi.class.getName(), kfAttr, (arg) -> keyFactory(provider, OSSLKeyType.ED448));

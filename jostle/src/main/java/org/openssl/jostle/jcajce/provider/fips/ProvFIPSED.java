...
class ProvFIPSED
{
    ...
    public void configure(final JostleFIPSProvider provider)
    {
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED",
                PREFIX + "EdDSAKeyPairGenerator", attr, (arg) -> keyPairGenerator("EDDSA"));
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED25519",
                ...
                (arg) -> keyPairGenerator(EdDSAParameterSpec.ED25519));
        ...
        provider.addAlgorithmImplementation("KeyPairGenerator", "ED448",
                ...
                (arg) -> keyPairGenerator(EdDSAParameterSpec.ED448));
        ...
        if (ed25519 || ed448)
        {
            provider.addAlgorithmImplementation("Signature", "EDDSA",
                    PREFIX + "EdSignatureSpi", sigAttr, (arg) -> signature(OSSLKeyType.NONE));
        ...
        if (ed25519)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519",
                    PREFIX + "EdSignatureSpi$ED25519", sigAttr, (arg) -> signature(OSSLKeyType.ED25519));
        ...
        if (ed25519ph)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519PH",
                    PREFIX + "EdSignatureSpi$ED25519ph", sigAttr, (arg) -> signature(OSSLKeyType.Ed25519ph));
            provider.addAlias("Signature", "ED25519PH", "Ed25519ph");
        }
        if (ed25519ctx)
        {
            provider.addAlgorithmImplementation("Signature", "ED25519CTX",
                    PREFIX + "EdSignatureSpi$ED25519ctx", sigAttr, (arg) -> signature(OSSLKeyType.Ed25519ctx));
            provider.addAlias("Signature", "ED25519CTX", "Ed25519ctx");
        }
        if (ed448)
        {
            provider.addAlgorithmImplementation("Signature", "ED448",
                    PREFIX + "EdSignatureSpi$ED448", sigAttr, (arg) -> signature(OSSLKeyType.ED448));
        ...
        if (ed448ph)
        {
            provider.addAlgorithmImplementation("Signature", "ED448PH",
                    PREFIX + "EdSignatureSpi$ED448ph", sigAttr, (arg) -> signature(OSSLKeyType.ED448ph));
        ...
        provider.addAlgorithmImplementation("KeyFactory", "ED",
                PREFIX + "EdKeyFactorySpi", kfAttr, (arg) -> keyFactory(OSSLKeyType.NONE));
        provider.addAlias("KeyFactory", "ED", "EDDSA", "EdDSA");
        provider.addAlgorithmImplementation("KeyFactory", "ED25519",
                PREFIX + "EdKeyFactorySpi$ED25519", kfAttr, (arg) -> keyFactory(OSSLKeyType.ED25519));
        ...
        provider.addAlgorithmImplementation("KeyFactory", "ED448",
                PREFIX + "EdKeyFactorySpi$ED448", kfAttr, (arg) -> keyFactory(OSSLKeyType.ED448));
        provider.addAlias("KeyFactory", "ED448", "Ed448");
        provider.addAlias("KeyFactory", "ED448", EdECObjectIdentifiers.id_Ed448);
    }

    private static EdKeyFactorySpi keyFactory(OSSLKeyType fixedType)
    {
        return new EdKeyFactorySpi(FIPSNISelector.EDServiceNI, FIPSNISelector.SpecNI,
                FIPSNISelector.Asn1NI, fixedType);
    }

    private static EdSignatureSpi signature(OSSLKeyType forcedType)
    {
        return new EdSignatureSpi(FIPSNISelector.EDServiceNI, keyFactory(OSSLKeyType.NONE), forcedType);
    }

    private static EdDSAKeyPairGenerator keyPairGenerator(Object algorithm)
    {
        return new EdDSAKeyPairGenerator(FIPSNISelector.EDServiceNI, FIPSNISelector.SpecNI,
                FIPSNISelector.Asn1NI, algorithm);
    }
}

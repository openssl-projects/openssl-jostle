...
class ProvKS
{
    ...
    public void configure(final JostleProvider provider)
    {
        ...
        provider.addAlgorithmImplementation("KeyStore", "PKCS12", KSServiceSPI.class.getName(), attr, (arg) -> new KSServiceSPI());
        ...
        // OpenSSL provider.
        provider.addAlgorithmImplementation("KeyStore", "PKCS12-3DES-3DES", KSServiceSPI.PKCS12_3DES_3DES.class.getName(), attr, (arg) -> new KSServiceSPI.PKCS12_3DES_3DES());
        provider.addAlias("KeyStore", "PKCS12-3DES-3DES", "PKCS12-DEF-3DES-3DES");

        provider.addAlgorithmImplementation("KeyStore", "PKCS12-AES256-AES128", KSServiceSPI.PKCS12_AES256_AES128.class.getName(), attr, (arg) -> new KSServiceSPI.PKCS12_AES256_AES128());
        provider.addAlias("KeyStore", "PKCS12-AES256-AES128", "PKCS12-DEF-AES256-AES128");

        provider.addAlgorithmImplementation("KeyStore", "PKCS12-PBMAC1", KSServiceSPI.PKCS12_PBMAC1.class.getName(), attr, (arg) -> new KSServiceSPI.PKCS12_PBMAC1());

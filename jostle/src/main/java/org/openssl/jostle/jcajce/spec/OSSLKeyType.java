...
public enum OSSLKeyType
{
    ...
    // RFC 7748 Montgomery curves for key agreement.
    // OIDs from RFC 8410: id-X25519 = 1.3.101.110, id-X448 = 1.3.101.111.
    X25519(27, "X25519", "1.3.101.110"),
    X448(28, "X448", "1.3.101.111");

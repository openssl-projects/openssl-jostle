 ...
 * {@code interface/fips/jni/dh_ni_jni.c}.
 */
/**
 * JNI implementation of DHServiceNI backed by the FIPS interface library;
 * the glue is the base bridge re-included under renamed exports.
 */
class DHServiceFIPSJNI implements DHServiceNI
{
    @Override

...
public enum OSSLCipher
{
    ...
    AES128(BLOCK, 16, ECB, CBC, CTS, CFB1, CFB8, CFB128, OFB, CTR, CCM, GCM, XTS, WRAP, WRAP_PAD, OCB),
    AES192(BLOCK, 16, ECB, CBC, CTS, CFB1, CFB8, CFB128, OFB, CTR, CCM, GCM, XTS, WRAP, WRAP_PAD, OCB),
    AES256(BLOCK, 16, ECB, CBC, CTS, CFB1, CFB8, CFB128, OFB, CTR, CCM, GCM, XTS, WRAP, WRAP_PAD, OCB),

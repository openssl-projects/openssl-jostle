...
/**
 * ECDH key-agreement SPI. Java 9+ override of the Java 8 baseline that
 * uses {@link Reference#reachabilityFence} to keep this SPI instance
...
public class ECDHKeyAgreementSpi extends KeyAgreementSpi
{
            ...
            throws InvalidKeyException, IllegalStateException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                // EVP_PKEY_derive_set_peer runs an internal
    ...
    {
        // Reject null / empty / whitespace-only algorithm names — see
        // the Java 8 baseline for the rationale.
